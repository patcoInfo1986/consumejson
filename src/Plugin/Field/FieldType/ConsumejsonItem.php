...
namespace Drupal\consumejson\Plugin\Field\FieldType;
 ...
 * @FieldType(
 *     id = "consumejson",
 *     label = @Translation("List (eBank)"),
 *     description = @Translation("Json Field."),
 *     category = @Translation("Json"),
 *     default_formatter = "consumejson_default",
 *     default_widget = "consumejson_default"
 * )
 */
class ConsumejsonItem extends FieldItemBase {
  ...
  public static function defaultFieldSettings() {
   ...
   public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    $output['jsonurl'] = array(
      '#type' => 'textfield',
      '#title' => t('Json url'),
      '#default_value' =>  $this->getSetting('jsonurl'),
    );
    return $output;
  }
